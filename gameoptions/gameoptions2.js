...
var question1 = function(){
    ...
    $(".q1").show();
    $(".buttons").html("<button class='btn btn-success q1-yes'>YES</button>");
    $(".buttons").append("<button class='btn btn-danger q1-no'>NO</button>");
...
var question2 = function(){
    ...
    $(".q2").show();
    $(".buttons").html("<button class='btn btn-success q2-rpg'>RPG</button>");
    $(".buttons").append("<button class='btn btn-danger q2-fps'>FPS</button>");
    $(".buttons").append("<button class='btn btn-info q2-sports'>SPORTS</button>");
    $(".buttons").append("<button class='btn btn-warning q2-adventure'>ADVENTURE</button>");
...
var question3 = function(q2_choice){
    ...
    $("div.narrative, span.q3").html("What type of " + q2_choice + " games do you like?");
    $(".q3").show();
    if(q2_choice === "RPG"){
...
var q3_buttons = function(b1Text, b2Text){
    ...
    $(".buttons").append("<button class='btn btn-danger q3-button2'>" + b2Text + "</button>");
    ...
    $(".q3-button1").click(function(){
       if(b1Text === "Science Fantasy"){
        ...
        displayChoice("Basketball", "NBA 2K18");
    }
